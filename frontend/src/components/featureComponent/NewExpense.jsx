...
const NewExpense = ({ finance }) => { 
    const handleSubmit = async (event) => { 
        ...
        if (expenseAmount > activeBudget.budgetAmount-activeBudget.expenseAmount) {
            return toast.error("Expense can't be greater than remaining budget");
        }

        if(expenseAmount<0){
            return toast.error("Expense can't be in negative")
        }
